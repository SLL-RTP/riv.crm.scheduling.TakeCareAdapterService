...
public class CancelBookingTestProducer extends TakeCareTestProducer implements BookingSoap {
	...
	public String cancelBooking(String tcusername, String tcpassword, String externaluser, String careunitidtype,
		...
		se.skl.skltpservices.takecare.booking.cancelbookingrequest.ProfdocHISMessage incomingProfdocHISMessage = new se.skl.skltpservices.takecare.booking.cancelbookingrequest.ProfdocHISMessage();
        incomingProfdocHISMessage
                = (se.skl.skltpservices.takecare.booking.cancelbookingrequest.ProfdocHISMessage) super.unmarshalXmlToProfdocHISMessage(incomingProfdocHISMessage, "urn:ProfdocHISMessage:CancelBooking:Request", xml);

		String incomingBookingId = incomingProfdocHISMessage.getBookingId();
		...
		String xmlResponse = createOkResponse(incomingBookingId);
		log.debug("xmlResponse:{xmlResponse}",xmlResponse);
		return xmlResponse;
	}
	...
	private String createOkResponse(String bookingId) {
		...
		outgoing_response.setMethod("Booking.CancelBooking");
