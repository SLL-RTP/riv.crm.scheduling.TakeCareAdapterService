...
public class TakeCareTestProducer {
     ...
     * @param profdocHISMessage
     * @param namespace
     * @return
     */
    public Object unmarshalXmlToProfdocHISMessage(Object profdocHISMessage, String namespace, String incoming_string) {
        
        log.debug("transformResponse:" + incoming_string);
